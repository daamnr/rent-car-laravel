...
@section('content')
<div class="hero" style="background-image: url('{{ asset('frontend/images/herocar.jpg') }}')">
  <div class="container">
    <div class="row align-items-center justify-content-center">
      <div class="col-lg-10">
        <div class="row mb-5">
          <div class="col-lg-7 intro">
            <h1 class="text-white"><strong>Sewa Mobil</strong> Dengan Satu Sentuhan.</h1>
          </div>
        </div>
        ...
        <div class="listing d-block align-items-stretch">
          ...
          <div class="listing-contents h-100">
            ...
            <div class="d-block mb-3 border-bottom pb-3">
              ...
              <div class="listing-feature pr-4">
                <span class="caption">No Plat:</span>
                <span class="string">{{ $car->plat }}</span>
              </div>
            </div>
            <div>
              <p>
