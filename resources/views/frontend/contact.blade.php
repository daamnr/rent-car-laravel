      ...
      <div class="col-lg-5">
        <div class="intro">
          ...
          <div class="custom-breadcrumbs">
            <a href="index.html" class="text-white">Home</a> <span class="mx-2">/</span>
      ...
      <div class="col-lg-4 ml-auto">
        <div class="bg-white p-3 p-md-5">
          ...
          <ul class="list-unstyled footer-link">
            ...
            <li class="d-block mb-3">
              <span class="d-block text-black">Phone:</span><span>{{ $setting->phone ?? "-" }}</span>
            </li>
            <li class="d-block mb-3">
              <span class="d-block text-black">Email:</span><span>{{ $setting->email ?? "-" }}</span>
            </li>
          </ul>
        </div>
      </div>
